...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "PIPELINE_OUTPUT" -parent ${Page_0}
...
proc update_PARAM_VALUE.PIPELINE_OUTPUT { PARAM_VALUE.PIPELINE_OUTPUT } {
	# Procedure called to update PIPELINE_OUTPUT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.PIPELINE_OUTPUT { PARAM_VALUE.PIPELINE_OUTPUT } {
	# Procedure called to validate PIPELINE_OUTPUT
	return true
}
...
proc update_MODELPARAM_VALUE.PIPELINE_OUTPUT { MODELPARAM_VALUE.PIPELINE_OUTPUT PARAM_VALUE.PIPELINE_OUTPUT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.PIPELINE_OUTPUT}] ${MODELPARAM_VALUE.PIPELINE_OUTPUT}
}
