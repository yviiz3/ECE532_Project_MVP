...
HD_PWD='c:/users/khanm/onedrive/documents/github/ece532_project_mvp/project/project.tmp/project_mvp_top_v1_0_project/project_mvp_top_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project_mvp_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project_mvp_top.tcl
