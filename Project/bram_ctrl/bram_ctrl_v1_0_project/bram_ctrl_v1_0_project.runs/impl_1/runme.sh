...
HD_PWD='c:/users/khanm/onedrive/documents/github/ece532_project_mvp/project/bram_ctrl/bram_ctrl_v1_0_project/bram_ctrl_v1_0_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_ctrl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bram_ctrl.tcl -notrace
