...
HD_PWD='c:/users/khanm/onedrive/documents/github/ece532_project_mvp/project/bram_ctrl/bram_ctrl_v1_0_project/bram_ctrl_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_ctrl.tcl
