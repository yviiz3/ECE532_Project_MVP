...
#
# Generated by Vivado on Tue Mar 31 13:38:43 -0400 2026
...
# Script info
echo -e "cordic_2.sh - Script generated by export_simulation (Vivado v2018.3.1 (64-bit)-id)\n"
...
simulate()
{
  xsim cordic_2 -key {Behavioral:sim_1:Functional:cordic_2} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
