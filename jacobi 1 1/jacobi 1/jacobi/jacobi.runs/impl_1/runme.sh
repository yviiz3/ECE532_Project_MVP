...
HD_PWD='C:/Users/khanm/OneDrive/Documents/GitHub/ECE532_Project_MVP/jacobi 1 1/jacobi 1/jacobi/jacobi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log svd_top_fsm_bram.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source svd_top_fsm_bram.tcl -notrace
