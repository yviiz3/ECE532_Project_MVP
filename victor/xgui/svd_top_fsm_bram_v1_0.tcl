...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "SWEEPS" -parent ${Page_0}
...
proc update_PARAM_VALUE.SWEEPS { PARAM_VALUE.SWEEPS } {
	# Procedure called to update SWEEPS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.SWEEPS { PARAM_VALUE.SWEEPS } {
	# Procedure called to validate SWEEPS
	return true
}
...
proc update_MODELPARAM_VALUE.SWEEPS { MODELPARAM_VALUE.SWEEPS PARAM_VALUE.SWEEPS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.SWEEPS}] ${MODELPARAM_VALUE.SWEEPS}
}
